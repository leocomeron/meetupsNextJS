...
async function getStaticProps() {
  //fetch data from API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://leocomeron:camerun@cluster0.wz0tu.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
